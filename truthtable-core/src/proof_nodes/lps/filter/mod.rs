use crate::proof_nodes::{
    HintGenerationPlan, OUTPUT_PLAN_KEY, cost::ProvingCost, prover::{ArgProverGadgetNode, ProverLpNode, ProverPlanNode}, tree::NodeId, verifier::{VerifierLpNode, VerifierNode}
};
use arithmetic::{
