// use crate::proof_nodes::{exprs::column::format_column_detail, id::NodeId, prover::ProverPlanNode};
...
//     root: &'a Arc<dyn ProverPlanNode<F, MvPCS, UvPCS>>,
// }
...
// {
//     pub fn new(root: &'a Arc<dyn ProverPlanNode<F, MvPCS, UvPCS>>) -> Self {
//         Self { root }
//     }
