...
use kit::ark_serialize::{CanonicalDeserialize, CanonicalSerialize};
use kit::ark_std::rand::Rng;
use errors::PCSError;
use transcript::Tr;
...
pub trait PolynomialCommitmentScheme<F: PrimeField + PrimeField> {
    /// Prover parameters
    ...
    fn multi_open(
        ...
        _polynomials: &[Arc<DenseMultilinearExtension<F>>],
        _points: &[Vec<F>],
        _evals: &[F],
    ...
    // TODO: Why do we need PrimeField for IOP stuff?
