...
use arithmetic::{
    ...
    mle::virt::{VPAuxInfo, VirtualPolynomial, build_eq_x_r_vec},
};
use ark_ec::{CurveGroup, pairing::Pairing, scalar_mul::variable_base::VariableBaseMSM};
use kit::ark_std::{One, Zero, end_timer, log2, start_timer};
use std::{collections::BTreeMap, iter, marker::PhantomData, ops::Deref, sync::Arc};
use sumcheck::{PolyIOP, structs::IOPProof, sum_check::SumCheck};
use transcript::Tr;
#[derive(Clone, Debug, Default, PartialEq, Eq)]
pub struct BatchProof<E, PCS>
where
    E: Pairing,
    PCS: PolynomialCommitmentScheme<E::ScalarField>,
{
...
where
    E: Pairing,
    PCS: PolynomialCommitmentScheme<E::ScalarField, Commitment = Commitment<E>>,
{
...
mod tests {
    ...
    use arithmetic::{
        ark_poly::{DenseMultilinearExtension, MultilinearExtension, Polynomial},
        mle::get_batched_nv,
    };
    use ark_ec::pairing::Pairing;
    use ark_test_curves::bls12_381::Bls12_381 as E;
    use kit::ark_std::{UniformRand, rand::Rng, test_rng, vec::Vec};
    ...
    fn test_multi_open_helper<R: Rng>(
        ...
        let mut transcript = Tr::new("test transcript".as_ref());
