...
use arithmetic::mle::mat::evaluate_opt;
use ark_ec::{
    pairing::Pairing,
...
impl<E: Pairing> PolynomialCommitmentScheme<E::ScalarField> for MultilinearKzgPCS<E> {
    // Parameters
...
mod tests {
    ...
    use arithmetic::ark_poly::{DenseMultilinearExtension, MultilinearExtension};
    use kit::ark_std::{test_rng, vec::Vec, UniformRand};
