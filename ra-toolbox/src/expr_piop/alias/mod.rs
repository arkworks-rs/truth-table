...
#[derive(Clone, Debug)]
pub struct AliasPIOPProverInput {
    pub alias: datafusion::logical_expr::expr::Alias,
}

#[derive(Clone, Debug)]
pub struct AliasPIOPVerifierInput {
    pub alias: datafusion::logical_expr::expr::Alias,
}

pub struct AliasExprPIOP;
    ...
    UvPCS: PCS<F, Poly = LDE<F>>,
{
    ...
    type ProverOutput = ();
    type VerifierOutput = ();
    type VerifierInput = AliasPIOPVerifierInput;
