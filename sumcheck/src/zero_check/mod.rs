...
use arithmetic::{ark_ff::PrimeField, mle::virt::eq_eval};
...
impl<F: PrimeField> ZeroCheck<F> for PolyIOP<F> {
    ...
    fn init_transcript() -> Self::Transcript {
        Tr::<F>::new(b"Initializing ZeroCheck transcript")
    }
...
mod test {
    ...
    use crate::{errors::PolyIOPErrors, zero_check::ZeroCheck, PolyIOP};
