use arithmetic::{ark_ff::PrimeField, ark_poly::DenseMultilinearExtension, mle::virt::{VPAuxInfo, VirtualPolynomial}};
...
mod test {
    ...
    use arithmetic::ark_poly::MultilinearExtension;
    use ark_test_curves::bls12_381::Fr;
    use kit::ark_std::{test_rng, UniformRand};
