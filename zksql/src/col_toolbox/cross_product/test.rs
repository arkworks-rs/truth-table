...
mod test {
    ...
    use crate::{
        tracker::prelude::*,
        col_toolbox::cross_product::cross_product::CrossProductIOP,
    };
    ...
    fn test_cross_product() -> Result<(), PolyIOPErrors> {
        ...
        let cross_table = CrossProductIOP::<<ark_ec::bls12::Bls12<ark_test_curves::bls12_381::Config> as ark_ec::pairing::Pairing>::ScalarField, MultilinearKzgPCS<Bls12_381>>::prover_cross_product(
            &a_table.clone(), 
            &b_table.clone(),
        )?;
        ...
        CrossProductIOP::<<ark_ec::bls12::Bls12<ark_test_curves::bls12_381::Config> as ark_ec::pairing::Pairing>::ScalarField, MultilinearKzgPCS<Bls12_381>>::verifier_cross_product(
            &a_table_comm,
            &b_table_comm,
        )?;
