...
mod test {
    ...
    use crate::{
        tracker::prelude::*,
        col_toolbox::set_intersect::set_intersect::SetIntersectIOP,
    };
    ...
    fn test_set_intersect() -> Result<(), PolyIOPErrors> {
        ...
        test_set_intersect_helper::<<ark_ec::bls12::Bls12<ark_test_curves::bls12_381::Config> as ark_ec::pairing::Pairing>::ScalarField, MultilinearKzgPCS::<Bls12_381>>(
            &mut prover_tracker, 
        ...
        let bad_res1 = test_set_intersect_helper::<<ark_ec::bls12::Bls12<ark_test_curves::bls12_381::Config> as ark_ec::pairing::Pairing>::ScalarField, MultilinearKzgPCS::<Bls12_381>>(
        ...
        let bad_res2 = test_set_intersect_helper::<<ark_ec::bls12::Bls12<ark_test_curves::bls12_381::Config> as ark_ec::pairing::Pairing>::ScalarField, MultilinearKzgPCS::<Bls12_381>>(
            &mut prover_tracker.deep_copy(), 
            &mut verifier_tracker.deep_copy(), 
            &poly_a_mle, 
            &a_sel_mle,
        ...
        print!("SuppCheck bad path 3 test: ");
        let poly_a_nums =   vec![0, 0, 0, 1, 2, 3, 4, 5];
        let a_sel_nums =    vec![0, 0, 1, 1, 1, 1, 1, 1];
        let poly_b_nums =   vec![1, 2, 8, 0]; 
        let b_sel_nums =    vec![1, 1, 1, 0];
        ...
        let bad_res3 = test_set_intersect_helper::<<ark_ec::bls12::Bls12<ark_test_curves::bls12_381::Config> as ark_ec::pairing::Pairing>::ScalarField, MultilinearKzgPCS::<Bls12_381>>(
            &mut prover_tracker.deep_copy(), 
            &mut verifier_tracker.deep_copy(), 
            &poly_a_mle, 
            &a_sel_mle,
    ...
    fn test_set_intersect_helper<F, PCS>(
        ...
        col_r_poly: &DenseMultilinearExtension<F>,
        col_r_sel: &DenseMultilinearExtension<F>,
    ...
    PCS: PolynomialCommitmentScheme<F>,
    {
        ...
        let col_r = Col::new(prover_tracker.track_and_commit_poly(col_r_poly.clone())?, prover_tracker.track_and_commit_poly(col_r_sel.clone())?);
        ...
        let col_r_comm = ColComm::new(verifier_tracker.transfer_prover_comm(col_r.poly.id), verifier_tracker.transfer_prover_comm(col_r.selector.id), col_r.num_vars());
