...
mod test {
    ...
    fn test_final_join_one_to_many_helper<F, PCS>(
        ...
        table_a_cols: &Vec::<DenseMultilinearExtension<F>>,
        table_b_cols: &Vec::<DenseMultilinearExtension<F>>,
        table_a_sel: &DenseMultilinearExtension<F>,
        table_b_sel: &DenseMultilinearExtension<F>,
    ...
    PCS: PolynomialCommitmentScheme<F>,
    {
        ...
        let mut table_a_col_comms = Vec::<TrackedComm<F, PCS>>::new();
        ...
        let mut table_b_col_comms = Vec::<TrackedComm<F, PCS>>::new();
    ...
    fn test_final_join_one_to_many_with_advice_helper<F, PCS>(
        ...
        a_join_col_index: usize,
        b_join_col_index: usize,
        transformed_a_cols: &Vec::<DenseMultilinearExtension<F>>,
    ) -> Result<(), PolyIOPErrors>
    where
    PCS: PolynomialCommitmentScheme<F>,
    {
        ...
        let table_b_sel_comm = verifier_tracker.transfer_prover_comm(table_b_sel_poly.id);
        let table_b_comm = TableComm::new(table_b_col_comms, table_b_sel_comm, table_b.num_vars());
        let mut transformed_a_col_comms = Vec::<TrackedComm<F, PCS>>::new();
