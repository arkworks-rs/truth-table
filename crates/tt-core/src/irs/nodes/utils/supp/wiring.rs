...
pub(super) fn populate_nodup_payload_prover<B: SnarkBackend>(
    ...
    nodup_payload
        .entry(crate::irs::nodes::utils::nodup::INPUT_LABEL.to_string())
...
pub(super) fn populate_lookup_payload_prover<B: SnarkBackend>(
    ...
    lookup_payload.insert(
        crate::irs::nodes::utils::lookup::INCLUDED_LABEL.to_string(),
        orig_rlc,
    );
    lookup_payload.insert(
        crate::irs::nodes::utils::lookup::SUPER_LABEL.to_string(),
        super_rlc,
    );
    virtualized_ir.set_payload_for_node(
        lookup_id,
