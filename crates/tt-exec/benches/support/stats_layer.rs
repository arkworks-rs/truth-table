    ...
    S: Subscriber + for<'span> LookupSpan<'span>,
{
    ...
    fn on_event(&self, event: &Event<'_>, ctx: Context<'_, S>) {
        ...
        // call. Streamed to its own JSONL line so a full per-invocation
        // history survives OOM. Same shape as `tracker_snapshot`; the
        // dashboard's Streaming tab groups them back by query.
