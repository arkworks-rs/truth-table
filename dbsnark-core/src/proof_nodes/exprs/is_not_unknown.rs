// Combined dbsnark-core/src/prover/nodes/exprs/is_not_unknown.rs and dbsnark-core/src/verifier/nodes/exprs/is_not_unknown.rs
...
#[derive(Clone)]
pub struct ProverIsNotUnknownExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
...
#[derive(Clone)]
pub struct VerifierIsNotUnknownExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>> + 'static,
    UvPCS: PCS<F, Poly = LDE<F>> + 'static,
...
impl<F, MvPCS, UvPCS> VerifierNode<F, MvPCS, UvPCS> for VerifierIsNotUnknownExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>>,
    UvPCS: PCS<F, Poly = LDE<F>>,
