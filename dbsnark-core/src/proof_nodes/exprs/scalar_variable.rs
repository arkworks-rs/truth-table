// Combined dbsnark-core/src/prover/nodes/exprs/scalar_variable.rs and dbsnark-core/src/verifier/nodes/exprs/scalar_variable.rs
...
impl<F, MvPCS, UvPCS> VerifierNode<F, MvPCS, UvPCS> for VerifierScalarVariableExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>>,
    UvPCS: PCS<F, Poly = LDE<F>>,
