// Combined dbsnark-core/src/prover/nodes/exprs/window_function.rs and dbsnark-core/src/verifier/nodes/exprs/window_function.rs
...
impl<F, MvPCS, UvPCS> VerifierNode<F, MvPCS, UvPCS> for VerifierWindowFunctionExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>>,
    UvPCS: PCS<F, Poly = LDE<F>>,
