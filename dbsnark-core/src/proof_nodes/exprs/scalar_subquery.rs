// Combined dbsnark-core/src/prover/nodes/exprs/scalar_subquery.rs and dbsnark-core/src/verifier/nodes/exprs/scalar_subquery.rs
...
#[derive(Clone)]
pub struct ProverScalarSubqueryExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
...
impl<F, MvPCS, UvPCS> ProverNode<F, MvPCS, UvPCS> for ProverScalarSubqueryExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
...
#[derive(Clone)]
pub struct VerifierScalarSubqueryExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>> + 'static,
    UvPCS: PCS<F, Poly = LDE<F>> + 'static,
...
impl<F, MvPCS, UvPCS> VerifierNode<F, MvPCS, UvPCS> for VerifierScalarSubqueryExprNode<F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>>,
    UvPCS: PCS<F, Poly = LDE<F>>,
