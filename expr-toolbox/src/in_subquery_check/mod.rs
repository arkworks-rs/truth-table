...
pub struct InSubqueryCheckPiop;

impl<F: PrimeField, MvPCS: PCS<F, Poly = MLE<F>>, UvPCS: PCS<F, Poly = LDE<F>>>
    PIOP<F, MvPCS, UvPCS> for InSubqueryCheckPiop
{
    type ProverInput = ExprPIOPProverInput<F, MvPCS, UvPCS, InSubquery>;
    type ProverOutput = ();
    type VerifierOutput = ();
    type VerifierInput = ExprPIOPVerifierInput<F, MvPCS, UvPCS, InSubquery>;
