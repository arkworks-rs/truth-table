...
pub struct GroupingSetCheckPiop;

impl<F: PrimeField, MvPCS: PCS<F, Poly = MLE<F>>, UvPCS: PCS<F, Poly = LDE<F>>>
    PIOP<F, MvPCS, UvPCS> for GroupingSetCheckPiop
{
    type ProverInput = ExprPIOPProverInput<F, MvPCS, UvPCS, GroupingSet>;
    type ProverOutput = ();
    type VerifierOutput = ();
    type VerifierInput = ExprPIOPVerifierInput<F, MvPCS, UvPCS, GroupingSet>;
