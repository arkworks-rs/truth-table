...
//         .track_and_commit_mat_mv_poly(&MLE::from_evaluations_vec(left_nv, left_activator))
//         .unwrap();
//     let left_col = TrackedCol::new(None, left_tr_p.clone(), Some(left_activator_p.clone()));
//     /////////////////////////////////////////////////////
...
//         .track_and_commit_mat_mv_poly(&MLE::from_evaluations_vec(right_nv, right_activator))
//         .unwrap();
//     let right_col = TrackedCol::new(None, right_tr_p.clone(), Some(right_activator_p.clone()));
...
//     let left_tracked_col_oracle = TrackedColOracle::new(None, left_comm, Some(left_activatorm), left_nv);
...
//     let right_tracked_col_oracle = TrackedColOracle::new(None, right_comm, Some(right_activatorm), right_nv);
