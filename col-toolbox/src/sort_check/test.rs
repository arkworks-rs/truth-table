...
// left_actv))         .unwrap();
//     let left_col = ArithCol::new(None, left_tr_p.clone(),
...
// right_actv))         .unwrap();
//     let right_col = ArithCol::new(None, right_tr_p.clone(),
...
//     let left_col_com = ColCom::new(None, left_comm, Some(left_actvm),
// left_nv);

//     let right_comm = verifier.track_mv_com_by_id(right_tr_p.id())?;
//     let right_actvm = verifier.track_mv_com_by_id(right_actv_p.id())?;
//     let right_col_com = ColCom::new(None, right_comm, Some(right_actvm),
// right_nv);     let perm_piop_verifier_input = PermPIOPVerifierInput {
//         left_col_com,
//         right_col_com,
//     };
