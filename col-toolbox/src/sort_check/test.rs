...
//     let left_arith_col_oracle = ArithColOracle::new(None, left_comm,
...
//     let right_arith_col_oracle = ArithColOracle::new(None, right_comm,
// Some(right_actvm), right_nv);     let perm_piop_verifier_input =
// PermPIOPVerifierInput {         left_arith_col_oracle,
