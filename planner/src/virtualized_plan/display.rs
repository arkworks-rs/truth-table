...
/// Display helper that renders a Graphviz DOT graph for a `VirtualizedPlan`
/// tree.
pub struct DisplayableVirtualizedPlan<'a, F, MvPCS, UvPCS>
where
    F: PrimeField,
    ...
    UvPCS: PCS<F, Poly = LDE<F>>,
{
    ...
    plan: &'a VirtualizedPlan<F, MvPCS, UvPCS>,
}

impl<'a, F, MvPCS, UvPCS> DisplayableVirtualizedPlan<'a, F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>>,
    UvPCS: PCS<F, Poly = LDE<F>>,
{
    ...
    pub fn graphviz(&self) -> String {
        ...
        out.push_str("digraph VirtualizedPlan {\n");
...
impl<'a, F, MvPCS, UvPCS> fmt::Display for DisplayableVirtualizedPlan<'a, F, MvPCS, UvPCS>
where
    F: PrimeField,
    MvPCS: PCS<F, Poly = MLE<F>>,
    UvPCS: PCS<F, Poly = LDE<F>>,
